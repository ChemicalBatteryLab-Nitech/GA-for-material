...
4. Preparation of "inp_ga.py" file  
    ...
    |----|----|----| 
    | mlga | True | Set to True when running GAML. |
    | mlopt1 | 10 | The number of uniform crossovers per generation: the number of machine learning predictions (POPULATION * SURVIVAL_RATE - mlopt). |
    | mlopt2 | 10 | The number of two-point crossovers per generation. |
    | mlopt3 | 3 | The number of mutations per generation. |
    | mlext1 | 200 | The number of candidate genes for two-point crossover when making machine learning predictions. |
    | mlext2 | 200 | The number of candidate genes for uniform crossover when making machine learning predictions. |
    | mlext3 | 200 | The number of candidate genes for mutation when making machine learning predictions. |
    | outMLpred | "sort_label.out" | The filename with genes ordered in descending order of energy. |
    | outMLreg | "test_rmse.out" | The filename containing the RMSE after machine learning predictions. |
    | dirML | "MLrun" | The directory name for saving data obtained from machine learning predictions. |
